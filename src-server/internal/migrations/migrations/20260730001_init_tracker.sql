...
-- 20260804001 local_repositories、20260804002 项目↔仓库中间表+issue 分支、20260809001 issue_worktrees、
-- 20260809002 workspace.worktree_root、20260811001 local_repository.default_branch）。
...
-- 开发阶段不存本表（原「stateId 推进开发步骤」流程已移除，后续由 AI 驱动流程另行设计）。
